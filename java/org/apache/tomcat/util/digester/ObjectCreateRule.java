...
public class ObjectCreateRule extends Rule {
    ...
    public void begin(String namespace, String name, Attributes attributes)
        ...
        if (attributeName != null) {
            String value = attributes.getValue(attributeName);//查找指定属性
            if (value != null) {
                realClassName = value;
            }
        }
        ...
        Class<?> clazz = digester.getClassLoader().loadClass(realClassName); //使用TCCL 线程上下文类加载器 即CatalinaClassLoader
